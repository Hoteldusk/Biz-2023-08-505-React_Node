/**
 * 매직스트링, 매직넘버링 사용금지
 *  코딩을 하다보면 따옴표로 둘러쌓인 문자열, 직접 숫자로 작성된 데이터를 사용할 일이 많다
 ...
 *  전역적으로 변수를 선언하고 그 변수를 참조하여 코딩하는 것이 조금이나마 오류를 방지할 수 있다
 */

// java final static 으로 문자열을 미리 만들어두고 가져다 사용하는 것을 JS 에서 응용하기 위한 것
const URL = {
  HELLO: "/bbs",
