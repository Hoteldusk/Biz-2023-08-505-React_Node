 ...
 * React 에서는 기본적으로 Server 개념이 없는데, react-router 가 서버처럼 Form 에 담긴 데이터를 처리하는
 * 과정을 수행한다
 * 데이터 처리를 하는 함수가 action 함수이다
 * 이 함수를 react 가 호출할때 2개의 매개변수 값을 전달하는데, request, params 이다
...
export const updateAction = async ({ request, params }) => {
  ...
  // DB로 부터 SELECT 한 bucket 에 input 으로 입력한 데이터를 Update 하여 새로운 bucket 생성하기
