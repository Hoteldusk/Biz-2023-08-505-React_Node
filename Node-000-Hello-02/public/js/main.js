 ...
 * Element.prototype : 기본적으로 JS, HTML 에서 제공하지 않는 함수를 추가할때 사용하는 키워드
 * Element.prototype.css function() : Element tag 에 css 라는 이름으로 새로운 함수를 하나 등록하겠다
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // document.querySelector("div.mypage").innerHTML =
  //   "여기는 나의 페이지야 접근 가능";
});
