...
/**
 * 얕은복사 : 배열의 주소만 복사되어 원본과 복사본 배열이 동일한 배열
 *      만약 복사본 배열의 요소중 값이 변경되면 원본도 같이 변경된다
 */

/**
 * 전개연산자 : (...Spread operation)을 이용한 깊은 복사
 *      배열의 요소값 한개한개를 일일이 모두 복사하는 방법
 * 원본과 복사본이 완전히 동일한 값을 갖지만, 복사본과 원본은 서로 다른 기억장치에 저장된다
...
/**
 * ES 5 이전의 JS 에서 사용하는 for 반복문을 이용한 깊은복사
 */
