...
// ES6 만들어진 객체의 구조분해
// 객체의 각 속성(properties, 변수항목)을 분해하여 개별변수로 생성하기
console.log(student1.name);

const { name, tel, age } = student1;
console.log(age);

// 객체를 구조분해를 하면 객체,속성,형식으로 사용하는 것보다
// 각 속성의 값을 참조할때 코드를 짧게 할 수 있다
...
// func 호출하면서 다수의 값을 전달하면 첫번째와 두번째는 일반 변수(num1, num2)에 받고
